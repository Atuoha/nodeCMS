'use strict';const express=require("express"),app=express(),router=express.Router(),Category=require("../../models/Category"),faker=require("faker"),{userAuth}=require("../../helpers/authenticate");router.all("/*",userAuth,(b,c,a)=>{b.app.locals.layout="admin";a()});router.get("/",(b,c)=>{Category.find().then(a=>{c.render("admin/category/index",{categories:a})}).catch(a=>console.log(a))});
